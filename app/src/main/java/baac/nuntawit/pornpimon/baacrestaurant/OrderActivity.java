...
public class OrderActivity extends AppCompatActivity {
    ...
    private void createListView() {
        ...
        //ต้องเรียงค่าตามที่ MyAdapter ส่งมา
    ...
    private void postNewOrder() {
        ...
        try {
            ...
            Toast.makeText(OrderActivity.this,"Update Order to mySQL",Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
    ...
    private void createSpinner() {
        ...
        //Active When Choose setOnItemSelectedListener สามารถเลือกแบบเปลี่ยนได้ใช้กับการเลือกโต๊t
